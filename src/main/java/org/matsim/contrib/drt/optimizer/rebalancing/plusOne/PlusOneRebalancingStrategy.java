 ...
 * 
 * 02/02/2024 sh: Modified the PassengerRequestScheduledEvent handler to cover for the case of dispatcher that re-schedule 
 * requests (which lead to a null link).
 *
 * @author Chengqi Lu
 */
